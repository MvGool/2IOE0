...
public class FoodObject extends GameObject {
	...
	public FoodObject(Vector3f position, Vector3f rotation, Vector3f scalar, Mesh[] meshes) {
		super(position, rotation, scalar, meshes);
	}
	
	public FoodObject(Vector3f position, Vector3f rotation, Vector3f scalar) throws Exception {
