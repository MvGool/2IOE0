...
public class SinglePlayerPage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SinglePlayerMode
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SinglePlayerPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SinglePlayerPage().setVisible(true);
            }
        });
    }
